...
const ProblemCreateContainer = props => {
  ...
  const validate = () => {
    ...
    if (!(problem.problem.body || problemPdf instanceof File)) {
  ...
  return (
    <>
      ...
      <AnswerExplanationPdf explanationPdf={explanationPdf} setExplanationPdf={setExplanationPdf} />
          ...
          <Form.Item>
            <Row>
              ...
              {createdId !== -1 && (
                <Button
                  onClick={() =>
                    history.push(`/admin/problems?active_tab=2&problem_id=${createdId}`)
                  }
